...
* Package
  :PROPERTIES:
  :EXPORT_HUGO_SECTION: hm-package
  :END:
** The =hm= Package
   :PROPERTIES:
   :CUSTOM_ID: hm
...
* Requirements
  :PROPERTIES:
  :EXPORT_HUGO_SECTION: requirements
  :END:
...
*** Use the =hm= name space
 ...
 #+name: in-package
 #+header: :exports code :results value :wrap example
 #+BEGIN_SRC lisp
 (use-package :hm)
 #+END_SRC
...
* Examples
  :PROPERTIES:
  :EXPORT_HUGO_SECTION: example-projects
  :END:
...
[[/fig-12-section-w-interfaces.png]]
 ...
 A stratigraphic DAG for the information displayed on Figure [[fig-12-correlations]]
 ...
 [[file:/fig-12-correlations.png][file:/fig-12-correlations-small.png]]
...
*** Roskams' H-structure
   ...
   The problem is illustrated in Figure [[roskams-14]], which shows a
...
[[/fig-14.png]]
   ...
   [[roskams-h-bad]].  The incorrect Harris matrix indicates that Context 2 is
   younger than Context 4, when in fact that relationship cannot be determined.

 #+name: roskams-h-bad
 #+caption: Incorrect Harris matrix for the stratigraphic section shown in Figure [[roskams-14]].
 #+caption: The H-structure is drawn in red.
 [[/fig-14-h-structure.png]]


 A correct Harris matrix for the stratigraphic situation displayed on Figure
 [[roskams-14]] might be drawn on a Linux system with the =hm= software as follows:
 ...
 The correct Harris matrix drawn by this command is shown on Figure [[hm-roskams-h]].

 #+name: hm-roskams-h
 #+caption: A correct Harris matrix for Figure [[roskams-14]] drawn by the =hm= software.
 [[/roskams-h-sequence.png]]
...
*** Roskams' Jumps
 ...
 avoid a jump.
 #+BEGIN_QUOTE
 The stratigraphic situation \dots [(fig. [[roskams-jumps-illustration]])] comprises
 ...
 the chronological relationship of Context 1 with Contexts 3 or 4 (fig. [[roskams-jumps-sequence]]).

 #+name: roskams-jumps-sequence
 #+caption: Stratigraphic DAG illustrating the situation illusrated in Figure [[roskams-jumps-illustration]].
 [[/roskams-jumps-sequence.png]]
...
*** Herzog and Scollar's Complex H-structure
 ...
 The resulting graphic (fig. [[complex-h-structure]]) has six crossings, all but
 ...
 [[/complex-h-structure-reachable-2.png]]
...
*** Çatalhöyük
 ...
 are shown in Figures [[bldg-1-5-seq]] and [[bldg-1-5-chron]].

 #+name: bldg-1-5-seq
 #+caption: Stratigraphic DAG of the North Area sequence based on a Harris matrix created by Craig Cessford.
 [[file:/bldg-1-5-sequence.png][file:/bldg-1-5-sequence-small.png]]
 ...
 [[file:/bldg-1-5-chronology.png][file:/bldg-1-5-chronology-small.png]]
* Classifiers
  :PROPERTIES:
  :EXPORT_HUGO_SECTION: classifiers
  :END:
** Classifiers
   :PROPERTIES:
   :EXPORT_FILE_NAME: index
...
**** DONE Periods and Phases
 ...
 [[file:/fig-12-periods.png][file:/fig-12-periods-small.png]]
...
**** Adjacent
 ...
 section shown on Figure [[roskams-14]].
 ...
 orange, the graph in Figure [[roskams-h-dark]] results.

 #+name: roskams-h-dark
 #+caption: A correct Harris matrix for Figure [[roskams-14]] classified by adjacency to Context 2.
 #+caption: Colors are from the [[http://ethanschoonover.com/solarized][Solarized]] dark palette.
 [[/roskams-h-sequence-solarized-dark.png]]
 ...
 diagram (fig. [[roskams-h-dark]]) shows Context 2 adjacent to Context 3, but
...
**** Reachable
 ...
 A stratigraphic DAG for the information displayed on Figure [[1332-reachable]]
 might be drawn on a Linux system with the =hm= software as follows:
 ...
 [[file:/bldg-1-5-sequence-reachable-1332+.png][file:/bldg-1-5-sequence-reachable-1332+-small.png]]
...
**** Distance
 ...
 [[file:/bldg-1-5-sequence-distance-1332+.png][file:/bldg-1-5-sequence-distance-1332+-small.png]]
...
**** Levels
 ...
 [[file:/bldg-1-5-sequence-levels.png][file:/bldg-1-5-sequence-levels-small.png]]
...
* Attributes
  :PROPERTIES:
  :EXPORT_HUGO_SECTION: graph-attributes
  :END:
...
***** Solarized
 ...
 a light background (Fig. [[roskams-h-light]]).
 ...
 When the following command is run on a Linux system, the graph in Figure [[roskams-h-light]]
 results.
...
***** Brewer Color Palettes
 ...
 [[bldg-1-5-seq]] illustrates use of the =paired= color palette with a
...
**** Polygons
 ...
 [[file:/fig-12-polygon-1.png][file:/fig-12-polygon-1-small.png]]
...
* Configuration
  :PROPERTIES:
  :EXPORT_HUGO_SECTION: configuration-file
  :END:
...
* Files
  :PROPERTIES:
  :EXPORT_HUGO_SECTION: data-tables
  :END:
** Data Tables
   :PROPERTIES:
   :CUSTOM_ID: data-tables
   :EXPORT_FILE_NAME: index
   :EXPORT_HUGO_WEIGHT: 140
   :END:
...
* Description
  :PROPERTIES:
  :EXPORT_HUGO_SECTION: technical-description
  :END:
